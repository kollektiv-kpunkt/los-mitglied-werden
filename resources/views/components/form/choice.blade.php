<div class="los-input-group los-input-radio-group los-input-group-w-fit">
    ...
    <label for="{{$key}}" class="los-input-radio-label text-2xl flex gap-3 bg-accent text-white bg-opacity-30 px-4 py-3 items-center border-2 border-accent rounded-sm">
